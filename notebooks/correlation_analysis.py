...
print("데이터를 불러오는 중...")
df_semi = spark.read.parquet(f"{base_path}/silver_semiconductor.parquet")
df_fin = spark.read.parquet(f"{base_path}/silver_kfinance.parquet")
...
# "반도체 수출이 늘어나는 '충격'이 발생하면, 주가도 즉각 상승하며 그 영향이 몇 달간 지속된다"고 해석합니다.
